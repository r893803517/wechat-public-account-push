...
const USER_CONFIG = {
  ...
  USERS: [
    ...
    },
    {
      ...
      name: 'BB',
      // 使用微信测试号：扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oKVAU53sVnrQfE2QN7S9UV0Dc9TI', // oKVAU5-ToL6RAessVGmAkljssn1g
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: '5uXv2jrmtbdrsMbRLOD4MaBa5UWITPXaLE7djRq64i0',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      horoscopeDate: '10-20',
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
  ...
  CALLBACK_TEMPLATE_ID: 'JYLnukS-z3E82UEAj_1LrGmA7Li2OLWTp4bkoM_dpKc',

  CALLBACK_USERS: [
    {
      name: '自己',
      // 使用微信测试号：自己的微信id，扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oKVAU53sVnrQfE2QN7S9UV0Dc9TI',
    }
  ],
